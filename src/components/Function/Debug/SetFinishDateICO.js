...
import { setFinishDateICO } from '../../../utils/debug/setFinishDateICO';
...
class SetFinishDateICO extends Component {
  constructor(props) {
    super(props);
  ...
  async setFinishDate() {
    ...
    await setFinishDateICO(date).then(async (result) => {
        ...
        <div>
          <div>
            <Card style={{ backgroundColor: 'whitesmoke' }}>
              <CardBlock>
                <h5>Enter Finish Date ICO</h5>
                  <Input
                    value={this.state.finishDate}
                    placeholder="Date for finish ICO"
...
export default SetFinishDateICO;
