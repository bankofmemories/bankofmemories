...
export async function removePrivilegedWallet(addressPrivilegedWallet) {
  ...
  const tokens = await instance.removePrivelegedWallet(addressPrivilegedWallet * 100, { gas: 4412200, from: account })
